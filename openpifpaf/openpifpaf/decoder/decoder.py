...
class Decoder:
    ...
    @staticmethod
    def fields_batch(model, image_batch, *, device=None, targets=None):
        ...
        with torch.no_grad():
            ...
            with torch.autograd.profiler.record_function('model'):
                heads = model(image_batch, targets, [True for t in model.head_nets])
    ...
    def batch(self, model, image_batch, *, device=None, gt_anns_batch=None):
        ...
        fields_batch = self.fields_batch(model, image_batch, device=device, targets=targets)
